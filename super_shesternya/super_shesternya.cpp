...
// super_shesternya.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CsupershesternyaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CsupershesternyaApp

CsupershesternyaApp::CsupershesternyaApp()
{
...
// Единственный объект CsupershesternyaApp

CsupershesternyaApp theApp;


// Инициализация CsupershesternyaApp

BOOL CsupershesternyaApp::InitInstance()
{
